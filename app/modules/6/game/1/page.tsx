...
export const metadata = { title: "Heart Attack Assessment - Module 6 - Nestle SHE Day" };
  ...
  return (
    <div className="min-h-screen bg-gray-50 max-w-2xl mx-auto">
      ...
      <div className="bg-blue-700 px-5 py-3 flex items-center gap-3">
        <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white font-black text-sm">HA</div>
        <div><p className="text-white font-bold text-[14px]">Heart Attack Assessment Exam</p><p className="text-white/70 text-[11px]">Module 6 . Game 1 of 4 . Heart Health</p></div>
