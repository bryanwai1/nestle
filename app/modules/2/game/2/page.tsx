...
export const metadata = { title: "Hazard Image Spotter — Module 2 · Nestlé SHE Day" };
  ...
  return (
    <div className="min-h-screen bg-gray-50 max-w-2xl mx-auto">
      ...
      <div className="bg-red-600 px-5 py-3 flex items-center gap-3">
        ...
        <div>
          <p className="text-white font-bold text-[14px]">Hazard Image Spotter</p>
          <p className="text-white/70 text-[11px]">Module 2 · Game 2 of 3 · Slips, Trips & Falls</p>
        </div>
